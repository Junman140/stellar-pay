            ...
            >
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <button className="px-4 py-2 bg-white text-black rounded-lg hover:bg-neutral-200 transition-all text-sm font-medium">
                    Redeem
                  </button>
                  <button className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-all text-sm flex items-center justify-center gap-2">
            ...
            {burnHistory.map((burn, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="font-mono text-xs text-neutral-500 hover:text-white transition-colors">
                    {burn.hash}
                  </button>
                </div>
              </motion.div>
